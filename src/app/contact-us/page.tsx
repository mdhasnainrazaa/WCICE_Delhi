              ...
              <div className="bg-white/60 backdrop-blur-2xl border border-white p-8 rounded-[32px] shadow-[0_20px_40px_-15px_rgba(37,99,235,0.15)] relative">
                ...
                <div className="space-y-8">
                  ...
                  <div className="flex items-start gap-4 pt-4 border-t border-gray-100">
                    ...
                    <div>
                      <div className="text-sm font-bold text-[#64748B] mb-2">Social Connect</div>
                      <div className="flex gap-3">
                        <a href="https://www.facebook.com/profile.php?id=61569910095151" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white border border-[#E2E8F0] rounded-xl flex items-center justify-center hover:bg-[#2563EB] hover:text-white transition-all shadow-sm group">
                          <FacebookIcon size={20} className="text-[#2563EB] group-hover:text-white" />
                        </a>
                        <a href="https://www.instagram.com/wciecdelhi/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white border border-[#E2E8F0] rounded-xl flex items-center justify-center hover:bg-gradient-to-tr hover:from-[#F58529] hover:via-[#DD2A7B] hover:to-[#8134AF] hover:text-white transition-all shadow-sm group">
                          <InstagramIcon size={20} className="text-[#E1306C] group-hover:text-white" />
                        </a>
                        <a href="https://www.linkedin.com/company/wciecdelhi/" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-white border border-[#E2E8F0] rounded-xl flex items-center justify-center hover:bg-[#0077B5] hover:text-white transition-all shadow-sm group">
                          <LinkedinIcon size={20} className="text-[#0077B5] group-hover:text-white" />
                        </a>
                      </div>
                    </div>
                  </div>
