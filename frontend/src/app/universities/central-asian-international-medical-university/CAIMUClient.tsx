...
import { 
  ...
  Download, Phone, ChevronDown, Trophy, ShieldCheck, 
  Coffee, Building2, ArrowRight, 
  Microscope, Library, HeartPulse, Award, Users, 
  Target, Mail, Activity, Eye,
  Landmark, BookOpenCheck, PlayCircle, Sparkles, FileText
} from "lucide-react";
...
export default function CAIMUClient() {
        ...
        <div className="max-w-[1200px] mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mt-16">
            {[
              ...
              { title: "Clinical Exposure", icon: HeartPulse },
