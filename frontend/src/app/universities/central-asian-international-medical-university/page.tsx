...
export const metadata: Metadata = (() => {
  const uni = universities.find(u => u.slug === "central-asian-international-medical-university");
  if (!uni) return { title: "Central Asian International Medical University Not Found" };
