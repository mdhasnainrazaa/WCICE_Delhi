  ...
  return (
    <div className="fixed bottom-6 right-6 z-[60] flex flex-col gap-4 floating-whatsapp">
      ...
      <motion.a
        ...
        whileTap={{ scale: 0.9 }}
        aria-label="Chat with WCIEC MBBS expert on WhatsApp"
        className="w-14 h-14 bg-[#25D366] text-white rounded-full flex items-center justify-center shadow-2xl shadow-green-500/40 relative group will-change-transform"
      >
